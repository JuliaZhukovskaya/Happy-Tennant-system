...
class Address(models.Model):
    street = models.CharField(max_length=50, null=False, verbose_name="Улица")
    apartment = models.CharField(max_length=10, null=False, verbose_name="Квартира")
    city = models.CharField(max_length=50, null=False, verbose_name="Город")
    zipCode = models.CharField(max_length=15, null=False, verbose_name="Индекс")
